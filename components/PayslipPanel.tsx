      ...
      {breakdown && (
        <div style={{ marginTop: 12, paddingTop: 12, borderTop: `1px solid ${LINE}` }}>
          ...
          <div style={{ fontSize: 11, color: MUTE, marginTop: 8, lineHeight: 1.5 }}>
            ...
            Budgeted spending isn&apos;t held back here — check <b style={{ color: NAVY }}>Reconcile</b>&apos;s variance report for how that&apos;s tracking. Change what
            percentage goes where on the <b style={{ color: NAVY }}>Pay split</b> tab.
          </div>
        </div>
      )}
