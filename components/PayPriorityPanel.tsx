...
import { GOLD_MUTE, SURFACE_SUBTLE, LINE, MUTE, GOLD, NAVY, UNFAV, PIE_COLORS, selStyle } from "@/lib/theme";
  ...
  return (
    <Panel title="Pay split" icon={ListOrdered}>
      ...
      <div style={{ fontSize: 11, color: MUTE, marginTop: 6, lineHeight: 1.5 }}>
        A new destination lands at 20% — adjust it and the others so they add up the way you want. Create a goal (and set its target,
        due date, or account) on the <Link href="/savings" style={{ color: NAVY, fontWeight: 600 }}>Wealth</Link> tab.
      </div>
